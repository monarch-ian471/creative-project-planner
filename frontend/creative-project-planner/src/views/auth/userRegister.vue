  ...
  <div class="flex min-h-full flex-1">
    <div class="isolate px-6 py-12 sm:py-32 lg:px-8 w-full">
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mt-2 text-lg text-gray-700">Fill in the details below to create a new account.</p>
      </div>
      <form
        class="mx-auto mt-10 max-w-4xl border border-gray-300 shadow-md ring-1 ring-gray-200 sm:rounded-lg p-8"
        @submit="handleSubmit"
      >
        <div class="space-y-12 ">

          <div class="pb-12">
            <h2 class="text-xl font-semibold leading-7 text-gray-900 text-center">Personal Information</h2>
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input
                    ...
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-custom-peach sm:text-sm sm:leading-6"
                  />
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <select
                    ...
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-custom-peach sm:max-w-xs sm:text-sm sm:leading-6"
                  >
          ...
          <div class="pb-12">
            <h2 class="text-xl font-semibold leading-7 text-gray-900">Notifications</h2>
                ...
                <div class="space-y-6">
                  <div class="relative flex gap-x-3">
                    <div class="flex h-6 items-center">
                      <input
                        ...
                        class="h-4 w-4 rounded border-gray-300 text-orange-400 focus:ring-custom-peach"
                      />
                    </div>
                    <div class="text-sm leading-6">
                      <label for="sms" class="font-medium text-gray-900">SMS</label>
                  ...
                  <div class="relative flex gap-x-3">
                    ...
                    <div class="text-sm leading-6">
                      ...
                      <p class="text-gray-500">Get notified by email.</p>
                    </div>
                  </div>
